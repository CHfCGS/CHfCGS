...
class FourDGrid {
    ...
    typedef std::list<Gridpoint> GridCell;

    //typedef vector<vector<GridCell> > twoDvector;
    typedef std::vector<std::vector<GridCell> > twoDvector;
    typedef std::vector<std::vector<twoDvector> > fourDvector;
private:
...
public:
    ...
    FourDGrid(const int size, const GraphT &base_graph) :    
        ...
        Grid(size, std::vector<std::vector<std::vector<GridCell>>>(size, std::vector<std::vector<GridCell>>(size, std::vector<GridCell>(size, GridCell()))))               
