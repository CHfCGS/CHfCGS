data=stuttgart-regbez #unbreakedDPVEPunfiltered #ChainPair2 # #bremen #ProDPExample #Intersection #baden-wuerttemberg #stuttgart-regbez #ZipOrderingTest #ProP_ILPChainPair #PairsToIdentify #IntersectionDiff #heapTest
echo "data: " "$data"
